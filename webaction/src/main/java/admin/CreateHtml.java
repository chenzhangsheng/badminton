...
/**
 * Created by zhangshengchen on 2017/8/29.
 */
import java.io.File;
...
public class CreateHtml {
    public static void main(String[] args) {
        try {
            ...
            configuration.setDirectoryForTemplateLoading(new File("D:\\logtest\\template\\"));
            ...
            Writer writer = new OutputStreamWriter(new FileOutputStream("D:\\logtest\\template\\success.html"),"UTF-8");
